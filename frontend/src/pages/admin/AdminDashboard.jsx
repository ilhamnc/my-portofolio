...
export default function AdminDashboard() {
  ...
  const fetchData = () => {
    Promise.all([
      fetch('https://my-portofolio-oxrha0vqc-ilhamnc-s-projects.vercel.app/api/profile').then(r => r.json()),
      fetch('https://my-portofolio-oxrha0vqc-ilhamnc-s-projects.vercel.app/api/experiences').then(r => r.json()),
      fetch('https://my-portofolio-oxrha0vqc-ilhamnc-s-projects.vercel.app/api/educations').then(r => r.json()),
      fetch('https://my-portofolio-oxrha0vqc-ilhamnc-s-projects.vercel.app/api/certifications').then(r => r.json()),
      fetch('https://my-portofolio-oxrha0vqc-ilhamnc-s-projects.vercel.app/api/projects').then(r => r.json()),
      fetch('https://my-portofolio-oxrha0vqc-ilhamnc-s-projects.vercel.app/api/skills').then(r => r.json()),
      fetch('https://my-portofolio-oxrha0vqc-ilhamnc-s-projects.vercel.app/api/tools').then(r => r.json())
  ...
  const handleDelete = async (endpoint, id) => {
    if (window.confirm('Yakin ingin menghapus?')) {
      await fetch(`https://my-portofolio-oxrha0vqc-ilhamnc-s-projects.vercel.app/api/${endpoint}/${id}`, { method: 'DELETE' });
      fetchData();
    }
  };
  ...
  const handleAddSkill = async (e) => {
    ...
    await fetch('https://my-portofolio-oxrha0vqc-ilhamnc-s-projects.vercel.app/api/skills', { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify(newSkill) });
  ...
  const handleAddTool = async (e) => {
    ...
    await fetch('https://my-portofolio-oxrha0vqc-ilhamnc-s-projects.vercel.app/api/tools', { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify(newTool) });
